...
export default function Home() {
	...
	const { control, register, watch, handleSubmit, setValue, getValues, reset } =
		setForm
	...
	//get tipe_ppn from newArray
	const tipe_ppns = newArray1?.map((item) => item.tipe_ppn)
